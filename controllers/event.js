...
exports.purchaseEventTicket = async (req, res) => {
  try {
    const { image, eventId, userId, gameId } = req.body;
...
// Update event game info details by ID
exports.updateGameInfoOfEvent = async (req, res) => {
  try {
    const { id } = req.params;
...
exports.placeBid = async (req, res) => {
  try {
    const { amount, image, eventId, userId, gameId } = req.body;
    // const { userId } = req.user;
